...
class Player {
  ...
  draw() {
    ...
    stroke(0); 
    fill(random(0, 256), random(0, 256), random(0, 256));
    rect(this.posX+15, this.posY-2    , this.size/2);
    fill(random(0, 256, random(0, 256), random(0, 256)));
     circle(this.posX, this.posY,this.size, this.posX-2, this.posY, this.posX+4, this.posY-20,this.size-20);
